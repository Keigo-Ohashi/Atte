...
class AttendanceRepository
{
    ...
    // 特定の日の勤務記録を取得
    public function getAttendanceListOfDay(String $date): LengthAwarePaginator
    {
        return Attendance::whereDate('clocked_in_at', $date)->join('users', 'user_id', '=', 'users.id')->paginate(5);
    }
